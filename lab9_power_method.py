#to find dominant eigen value and correspomding eigen vector of square matrix by power method
...
if itr>N:
    ...
    print(f"The dominent eigen value is {max_eigen_value} in {itr} iteration")
